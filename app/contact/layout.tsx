...
export const metadata: Metadata = {
  ...
  description: "Get in touch with Delegate AI Services Ltd. Book a free discovery call and receive a clear proposal within 48 hours. We respond within 24 hours.",
  openGraph: {
    title: "Contact Delegate | Get Your Free AI Consultation",
