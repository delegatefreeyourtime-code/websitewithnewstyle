...
import { ArrowRight, AlertCircle, CheckCircle2, Shield, Bell, Clock, MessageSquare } from "lucide-react";

const painPoints = [
  "No-shows and last-minute cancellations that could have been prevented with a timely reminder",
  "Reception spending 2 hours a day on calls that could be handled automatically",
  "Patients who need a follow-up appointment don't book — and fall out of your care pathway",
  "New patient onboarding involves the same paperwork and questions every single time",
];

const whatWeBuild = [
  {
    Icon: Bell,
    title: "Automated appointment reminder sequences",
    desc: "SMS/WhatsApp reminders sent 48 hours and 2 hours before every appointment. Dramatically fewer no-shows.",
  },
  {
    Icon: Clock,
    title: "No-show recovery workflows",
    desc: "When a patient misses, an instant rebooking prompt goes out automatically — filling the slot before the day is out.",
  },
  {
    Icon: MessageSquare,
    title: "New patient intake automation",
    desc: "Forms, consent documentation, and pre-appointment instructions collected automatically before the first visit.",
  },
  {
    Icon: CheckCircle2,
    title: "Post-treatment follow-up sequences",
    desc: "Automated check-ins that keep patients engaged, gather feedback, and prompt recall bookings at the right time.",
  },
];
...
const steps = [
  {
    num: "1",
    title: "Discovery",
    desc: "We map your booking flow and identify where patients fall out of your care pathway and where admin takes the most time.",
  },
  {
    num: "2",
    title: "Build",
    desc: "We build and test reminder sequences, intake flows, and follow-up automations. Typically live within 2 weeks.",
  },
  {
    num: "3",
    title: "Manage",
    desc: "Ongoing refinement based on patient response data. We track no-show rates and optimise continuously.",
  },
];
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            >
              <span className="text-sm font-medium text-[#8B8C95]">Built for UK dental practices</span>
            </motion.div>
            <h1 className="text-5xl font-bold tracking-tight text-[#F3F4F6] sm:text-6xl uppercase leading-tight">
              Every No-Show Costs You{" "}
              <span className="text-[#FF5A1F]">£150. Stop Losing Them.</span>
            </h1>
            <p className="mt-6 text-xl text-[#8B8C95] leading-relaxed">
              We build AI systems that send personalised appointment reminders, chase missed
              bookings, and handle routine patient queries — so your reception team can focus on
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-[#F3F4F6] leading-relaxed">
              ...
              workflow. The same principle applies to dental reminders — personalised, timely, zero manual effort.&rdquo;
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-[#8B8C95] leading-relaxed text-sm">
                If you don&apos;t see a measurable reduction in no-shows within 30 days, we&apos;ll
            ...
            >
              ...
              <p className="text-[#8B8C95] leading-relaxed text-sm">
                30 minutes. We&apos;ll quantify your current no-show cost and show you exactly how
                much of it could be eliminated with the right reminder system.
              </p>
            </motion.div>
          </div>
        </div>
        ...
        <div className="mx-auto max-w-4xl px-6 lg:px-8 relative z-10">
          ...
          >
            <h2 className="text-3xl font-bold text-[#F3F4F6] mb-4 uppercase">
              Stop leaving £150 on the table every time a patient doesn&apos;t show
            </h2>
            <p className="text-[#8B8C95] text-lg mb-8 max-w-2xl mx-auto">
              Book a 30-minute call. We&apos;ll tell you exactly how many no-shows your practice
              could prevent with an automated reminder system.
            </p>
