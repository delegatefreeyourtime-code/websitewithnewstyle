...
const RippleButton: React.FC<RippleButtonProps> = ({
  ...
  // Default variant
  const baseClasses = "relative border-none overflow-hidden isolate transition-all duration-200 cursor-pointer px-4 py-2 bg-[#FF5A1F] hover:bg-[#FF7040] text-white";
